/*! For license information please see polyfill.min.js.LICENSE.txt */ ! function(t, e) {
  "use strict";
  ...
  var S = function(t) {
      var e, r = o.defineProperty && function() {
        try {
          var t = {};
  ...
  S(c, {
    bind: function(e) {
      ...
      for (var n, i = f.call(arguments, 1), c = b(0, r.length - i.length), u = [], a = 0; a < c; a++) h.call(u, "$" + a);
  ...
  S(n, {
    forEach: function(e) {
      ...
      for (; ++i < c;) i in o && (void 0 !== r ? e.call(r, o[i], i, n) : e(o[i], i, n))
    }
  }, !U(n.forEach)), S(n, {
    map: function(e) {
      var n, o = A(this),
      ...
      for (var a = 0; a < c; a++) a in i && (u[a] = void 0 !== n ? e.call(n, i[a], a, o) : e(i[a], a, o));
      return u
    }
  }, !U(n.map)), S(n, {
    filter: function(e) {
      ...
      for (var a = 0; a < c; a++) a in i && (r = i[a], (void 0 === n ? e(r, a, o) : e.call(n, r, a, o)) && h.call(u, r));
      return u
    }
  }, !U(n.filter)), S(n, {
    every: function(e) {
      ...
      for (var c = 0; c < i; c++)
        if (c in o && !(void 0 === r ? e(o[c], c, n) : e.call(r, o[c], c, n))) return !1;
      return !0
    }
  }, !U(n.every)), S(n, {
    some: function(e) {
      ...
      for (var c = 0; c < i; c++)
        if (c in o && (void 0 === r ? e(o[c], c, n) : e.call(r, o[c], c, n))) return !0;
      return !1
    }
  }, !U(n.some));
  var Z = !1;
    ...
    reduce: function(e) {
      ...
      if (arguments.length >= 2) i = arguments[1];
        ...
        for (;;) {
          ...
          if (++c >= o) throw new TypeError("reduce of empty array with no initial value")
        }
  ...
  S(n, {
    splice: function(t, e) {
      for (var r, n = A(this), o = [], i = k(n.length), c = T(t), a = c < 0 ? b(i + c, 0) : g(c, i), s = g(b(T(e), 0), i - a), l = 0; l < s;) r = u(a + l), C(n, r) && (o[l] = n[r]), l += 1;
      var p, h = f.call(arguments, 2),
        y = h.length;
      if (y < s) {
        for (l = a; l < i - s;) r = u(l + s), p = u(l + y), C(n, r) ? n[p] = n[r] : delete n[p], l += 1;
        for (l = i; l > i - s + y;) delete n[l - 1], l -= 1
      } else if (y > s)
        for (l = i - s; l > a;) r = u(l + s - 1), p = u(l + y - 1), C(n, r) ? n[p] = n[r] : delete n[p], l -= 1;
      l = a;
  ...
  var X = !{
    ...
    tt = function() {
      ...
      for (var t in window)
        if (!V["$" + t] && C(window, t) && null !== window[t] && "object" == typeof window[t]) try {
          Q(window[t])
        } catch (t) {
          return !0
        }
  ...
  S(o, {
    keys: function(e) {
      ...
      var c = [],
        a = H && r;
      if (i && K || n)
        for (var s = 0; s < e.length; ++s) h.call(c, u(s));
      if (!n)
        for (var l in e) a && "prototype" === l || !C(e, l) || h.call(c, u(l));
      if (X)
  ...
  S(Date.prototype, {
      toISOString: function() {
        ...
        for (n = this.getUTCFullYear(), o = this.getUTCMonth(), n += Math.floor(o / 12), t = [(o = (o % 12 + 12) % 12) + 1, this.getUTCDate(), this.getUTCHours(), this.getUTCMinutes(), this.getUTCSeconds()], n = (n < 0 ? "-" : n > 9999 ? "+" : "") + I("00000" + Math.abs(n), 0 <= n && n <= 9999 ? -4 : -6), e = t.length; e--;)(r = t[e]) < 10 && (t[e] = "0" + r);
  ...
  Date.parse && !pt && !ft && lt || (Date = function(t) {
    ...
    S(e, {
      now: t.now,
      UTC: t.UTC
    }, !0), e.prototype = t.prototype, S(e.prototype, {
      constructor: e
    }, !0);
    return S(e, {
      parse: function(e) {
  ...
  var ht = l.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== (0xde0b6b3a7640080).toFixed(0)),
    yt = {
      ...
      multiply: function(t, e) {
        for (var r = -1, n = e; ++r < yt.size;) n += t * yt.data[r], yt.data[r] = n % yt.base, n = Math.floor(n / yt.base)
      },
      divide: function(t) {
        for (var e = yt.size, r = 0; --e >= 0;) r += yt.data[e], yt.data[e] = Math.floor(r / t), r = r % t * yt.base
      },
  ...
  S(l, {
    toFixed: function(t) {
      var e, r, n, o, i, c, a, l;
      if ((e = (e = s(t)) != e ? 0 : Math.floor(e)) < 0 || e > 20) throw new RangeError("Number.toFixed called with invalid number of decimals");
      ...
      if (n = "", r < 0 && (n = "-", r = -r), o = "0", r > 1e-21)
        if (c = (i = yt.log(r * yt.pow(2, 69, 1)) - 69) < 0 ? r * yt.pow(2, -i, 1) : r / yt.pow(2, i, 1), c *= 4503599627370496, (i = 52 - i) > 0) {
          for (yt.multiply(0, c), a = e; a >= 7;) yt.multiply(1e7, 0), a -= 7;
          for (yt.multiply(yt.pow(10, a, 1), 0), a = i - 1; a >= 23;) yt.divide(1 << 23), a -= 23;
          yt.divide(1 << a), yt.multiply(1, 1), yt.divide(2), o = yt.numToString()
        } else yt.multiply(0, c), yt.multiply(1 << -i, 0), o = yt.numToString() + I("0.00000000000000000000", 2, 2 + e);
      return o = e > 0 ? (l = o.length) <= e ? n + I("0.0000000000000000000", 0, e - l + 2) + o : n + I(o, 0, l - e) + "." + I(o, l - e) : n + o
    }
  }, ht), 2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? function() {
    var t = void 0 === /()??/.exec("")[1];
    a.split = function(r, n) {
      ...
      for (c = y.exec(o); c && !((u = c.index + c[0].length) > p && (h.call(s, I(o, p, c.index)), !t && c.length > 1 && c[0].replace(i, function() {
        ...
        }), c.length > 1 && c.index < o.length && h.apply(s, f.call(c, 1)), a = c[0].length, p = u, s.length >= d));) y.lastIndex === c.index && y.lastIndex++, c = y.exec(o);
  ...
  }, jt), 8 === parseInt(wt + "08") && 22 === parseInt(wt + "0x16") || (parseInt = function(t) {
    var e = /^0[xX]/;
    return function(r, n) {
      var o = u(r).trim(),
...
function(t, e) {
  ...
  var t, e, r, n, o = Function.prototype.call,
    i = Object.prototype,
    c = o.bind(i.hasOwnProperty),
    u = o.bind(i.propertyIsEnumerable),
    a = c(i, "__defineGetter__");
  a && (t = o.bind(i.__defineGetter__), e = o.bind(i.__defineSetter__), r = o.bind(i.__lookupGetter__), n = o.bind(i.__lookupSetter__)), Object.getPrototypeOf || (Object.getPrototypeOf = function(t) {
    var e = t.__proto__;
  ...
  if (Object.defineProperty) {
    var l = s({});
    if (!("undefined" == typeof document || s(document.createElement("div"))) || !l) var f = Object.getOwnPropertyDescriptor
  }
  if (!Object.getOwnPropertyDescriptor || f) {
    Object.getOwnPropertyDescriptor = function(t, e) {
      ...
      if (o = {
        ...
        var p = r(t, e),
          h = n(t, e);
        if (l && (t.__proto__ = s), p || h) return p && (o.get = p), h && (o.set = h), o
      }
  ...
  if (Object.getOwnPropertyNames || (Object.getOwnPropertyNames = function(t) {
    ...
    p = !({
      ...
      delete t.constructor, delete t.hasOwnProperty, delete t.propertyIsEnumerable, delete t.isPrototypeOf, delete t.toLocaleString, delete t.toString, delete t.valueOf, t.__proto__ = null;
      var e = function() {};
  ...
  if (Object.defineProperty) {
    ...
    if (!y || !d) var v = Object.defineProperty,
      b = Object.defineProperties
  }
  if (!Object.defineProperty || v) {
    Object.defineProperty = function(o, c, u) {
      if ("object" != typeof o && "function" != typeof o || null === o) throw new TypeError("Object.defineProperty called on non-object: " + o);
      if ("object" != typeof u && "function" != typeof u || null === u) throw new TypeError("Property description must be an object: " + u);
      if (v) try {
      ...
      if ("value" in u)
        ...
        if (!a && ("get" in u || "set" in u)) throw new TypeError("getters & setters can not be defined on this javascript engine");
...
function t(e, r, n) {
  ...
  2: [function(t, e, r) {
    ...
    if (!t) {
      ...
      r.type = "text/css", r.id = "matchmediajs-test", n.parentNode.insertBefore(r, n), e = "getComputedStyle" in window && window.getComputedStyle(r, null) || r.currentStyle, t = {
  ...
  function() {
    ...
    t.prototype = new Error, t.prototype.name = "InvalidCharacterError", e.btoa || (e.btoa = function(e) {
      for (var n, o, i = String(e), c = 0, u = r, a = ""; i.charAt(0 | c) || (u = "=", c % 1); a += u.charAt(63 & n >> 8 - c % 1 * 8)) {
        if ((o = i.charCodeAt(c += .75)) > 255) throw new t("'btoa' failed: The string to be encoded contains characters outside of the Latin1 range.");
        n = n << 8 | o
      }
      return a
      ...
      for (var o, i, c = 0, u = 0, a = ""; i = n.charAt(u++); ~i && (o = c % 4 ? 64 * o + i : i, c++ % 4) ? a += String.fromCharCode(255 & o >> (-2 * c & 6)) : 0) i = r.indexOf(i);
      return a
    })
  }(),
  function() {
    ...
    try {
      ...
      Array.prototype.slice = function(e, r) {
        if (r = void 0 !== r ? r : this.length, "[object Array]" === Object.prototype.toString.call(this)) return t.call(this, e, r);
        var n, o, i = [],
          c = this.length,
          u = e || 0;
  ...
  function(t) {
    function e(t, e) {
      function n(t) {
        ...
        this._keys = [], this._values = [], this._itp = [], this.objectOnly = e, t && r.call(this, t)
      }
      return e || v(t, "size", {
        get: h
  ...
  function(t) {
    ...
    t.exports = function(t, e) {
      var r, c, u, a = i(arguments.length, 2);
      for (t = Object(o(t)), u = function(n) {
        ...
        }, c = 1; c < a; ++c) n(e = arguments[c]).forEach(u);
      if (void 0 !== r) throw r;
      return t
    }
  }, function(t, e, r) {
  ...
  function(t, e) {
    ...
    function p(t, e, r, n) {
      var o = t._subscribers,
        i = o.length;
      t._onerror = null, o[i] = e, o[i + M] = r, o[i + C] = n, 0 === i && t._state && _(h, t)
    }
    ...
    function h(t) {
      var e = t._subscribers,
        r = t._state;
      if (0 !== e.length) {
        for (var n = void 0, o = void 0, i = t._result, c = 0; c < e.length; c += 3) n = e[c], o = e[c + r], n ? y(r, n, o, i) : o(i);
    ...
    function y(e, r, n, o) {
      ...
      if (i) {
        if (c = function(t, e) {
          ...
          }(n, o), c === D ? (p = !0, u = c.error, c.error = null) : s = !0, r === c) return void f(r, new TypeError("A promises callback cannot return that same promise."))
      } else c = o, s = !0;
      r._state !== k || (i && s ? a(r, c) : p ? f(r, u) : e === M ? l(r, c) : e === C && f(r, c))
    }

    function d(t) {
      t[A] = I++, t._state = void 0, t._result = void 0, t._subscribers = []
    }
    var v;
    ...
    var A = Math.random().toString(36).substring(2),
      ...
      N = function() {
        ...
        return t.prototype._enumerate = function(t) {
          ...
          if (a === o) {
            var s = c(t);
            if (s === n && t._state !== k) this._settledAt(t._state, e, t._result);
          ...
          var n = this.promise;
          n._state === k && (this._remaining--, t === C ? f(n, r) : this._result[e] = r), 0 === this._remaining && l(n, this._result)
      ...
      F = function() {
        function e(t) {
          this[A] = I++, this._result = this._state = void 0, this._subscribers = [], i !== t && ("function" != typeof t && function() {
