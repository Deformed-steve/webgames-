...
CarMovement.attributes.add("speed", {
...
}), CarMovement.attributes.add("cutter_entity", {
  type: "entity"
}), CarMovement.prototype.initialize = function() {
  CarMovement.instance = this, this.allow_input = !0, this.app.keyboard.on(pc.EVENT_KEYDOWN, this.onKeyDown, this), this.app.keyboard.on(pc.EVENT_KEYUP, this.onKeyUp, this), this.moveForward = !1, this.moveBackward = !1, this.turnLeft = !1, this.turnRight = !1, this.skin_index = parseInt(GameManager.instance.loadString("skin", "0")), this.currentSpeed = 0, this.entity.collision && this.entity.collision.on("collisionstart", this.onCollisionStart, this), CarMovement.volume = 0, CarMovement.volume_to = 0, this.cutter_entity.script.cutter.init(), this.changeSkin(this.skin_index), window.addEventListener("blur", function() {
    this.moveForward = !1, this.moveBackward = !1, this.turnLeft = !1, this.turnRight = !1
  }.bind(this))
}, CarMovement.prototype.changeSkin = function(e) {
  this.skin_index = e;
  for (let e = 0; e < this.skins.length; e++) this.skins[e].body.enabled = !1, this.skins[e].cutter_side_a.enabled = !1, this.skins[e].cutter_side_b.enabled = !1;
  this.skins[e].body.enabled = !0, this.skins[e].cutter_side_a.enabled = !0, this.skins[e].cutter_side_b.enabled = !0, Cutter.instance.updateSegments()
  ...
  this.currentSpeed = pc.math.lerp(this.currentSpeed, a, this.acceleration * e), SoundManager.instance.setPitch("engine_loop", .9 + Math.abs(this.currentSpeed) / 40);
  ...
  var h = -i * this.turnSpeed * .5 * n;
  this.entity.rigidbody.applyTorque(new pc.Vec3(0, h, 0));
  let l = 20 * i,
    d = this.wheel_right.getLocalEulerAngles(),
    p = pc.math.lerpAngle(d.y, l, 8 * e);
  this.wheel_left.setLocalEulerAngles(0, -p, 0), this.wheel_right.setLocalEulerAngles(0, p, 180), CarMovement.volume = pc.math.lerp(CarMovement.volume, CarMovement.volume_to, 5 * e), CarMovement.volume_to = 0, SoundManager.instance.setVolume("cutting_loop", CarMovement.volume)
...
Cutter.attributes.add("side_left", {
  ...
  type: "entity"
}), Cutter.attributes.add("car", {
  type: "entity"
}), Cutter.prototype.init = function() {
  Cutter.instance = this, this.segments = [], this.amount = 0, this.is_down = !0, this.car_script = this.car.script.carMovement
  ...
  this.segments = [];
  for (let e = 0; e < t; e++) {
    let s = this.car_script.skins[this.car_script.skin_index].cutter_segment.resource.instantiate();
...
UpgradeScreen.attributes.add("cont", {
  ...
  type: "entity"
}), UpgradeScreen.attributes.add("skin_01_button", {
  type: "entity"
}), UpgradeScreen.attributes.add("skin_02_button", {
  type: "entity"
}), UpgradeScreen.attributes.add("skin_03_button", {
  type: "entity"
}), UpgradeScreen.attributes.add("skin_04_button", {
  type: "entity"
}), UpgradeScreen.attributes.add("skin_02_ad_button", {
  type: "entity"
}), UpgradeScreen.attributes.add("skin_03_ad_button", {
  type: "entity"
}), UpgradeScreen.attributes.add("skin_04_ad_button", {
  type: "entity"
}), UpgradeScreen.attributes.add("selected_01", {
  type: "entity"
}), UpgradeScreen.attributes.add("selected_02", {
  type: "entity"
}), UpgradeScreen.attributes.add("selected_03", {
  type: "entity"
}), UpgradeScreen.attributes.add("selected_04", {
  type: "entity"
}), UpgradeScreen.attributes.add("reset_progress_button", {
  type: "entity"
}), UpgradeScreen.attributes.add("reset_progress_popup", {
  type: "entity"
}), UpgradeScreen.attributes.add("button_yes", {
  type: "entity"
}), UpgradeScreen.attributes.add("button_no", {
  type: "entity"
}), UpgradeScreen.attributes.add("close_pop_up_button", {
  type: "entity"
}), UpgradeScreen.prototype.initialize = function() {
  UpgradeScreen.instance = this, this.cont.enabled = !1, this.cooldown = .5, this.spread_ad_watched = !1, this.capacity_ad_watched = !1, this.speed_ad_watched = !1, this.reset_progress_popup.enabled = !1, this.close_button.button.on("click", (function() {
    this.hide()
    ...
    this.spread_ad_watched || this.handleUpgrade(this.spread_cost, function(t) {
      this.spread_level++, t && (this.spread_ad_watched = !0), Cutter.instance.spawnSegements(5 + this.spread_level), GameManager.instance.saveString("spread_level", this.spread_level)
    }.bind(this))
  }), this), this.capacity_button.button.on("click", (function() {
    this.capacity_ad_watched || this.handleUpgrade(this.capacity_cost, function(t) {
      t && (this.capacity_ad_watched = !0), this.capacity_level++, GameManager.instance.saveString("capacity_level", this.capacity_level)
    }.bind(this))
  }), this), this.speed_button.button.on("click", (function() {
    this.speed_ad_watched || this.handleUpgrade(this.speed_cost, function(t) {
      t && (this.speed_ad_watched = !0), this.speed_level++, GameManager.instance.saveString("speed_level", this.speed_level)
    }.bind(this))
  }), this), this.current_skin = CarMovement.instance.skin_index, this.skin_02_ad_watched = "true" == GameManager.instance.loadString("skin_02", ""), this.skin_03_ad_watched = "true" == GameManager.instance.loadString("skin_03", ""), this.skin_04_ad_watched = "true" == GameManager.instance.loadString("skin_04", ""), this.skin_01_button.button.on("click", (function() {
    this.updateSkin(0)
  }), this), this.skin_02_button.button.on("click", (function() {
    this.skin_02_ad_watched ? this.updateSkin(1) : this.handleSkinClick(function(t) {
      t && (this.skin_02_ad_watched = !0, GameManager.instance.saveString("skin_02", "true"), this.updateSkin(1))
    }.bind(this))
  }), this), this.skin_03_button.button.on("click", (function() {
    this.skin_03_ad_watched ? this.updateSkin(2) : this.handleSkinClick(function(t) {
      t && (this.skin_03_ad_watched = !0, GameManager.instance.saveString("skin_03", "true"), this.updateSkin(2))
    }.bind(this))
  }), this), this.skin_04_button.button.on("click", (function() {
    this.skin_04_ad_watched ? this.updateSkin(3) : this.handleSkinClick(function(t) {
      t && (this.skin_04_ad_watched = !0, GameManager.instance.saveString("skin_04", "true"), SoundManager.instance.playSound("register"), this.updateSkin(3))
    }.bind(this))
  }), this), this.reset_progress_button.button.on("click", (function() {
    this.cont.enabled = !1, this.reset_progress_popup.enabled = !0
  }), this), this.button_yes.button.on("click", (function() {
    this.onDeleteProgress()
  }), this), this.button_no.button.on("click", (function() {
    this.cont.enabled = !0, this.reset_progress_popup.enabled = !1
  }), this), this.close_pop_up_button.button.on("click", (function() {
    this.cont.enabled = !0, this.reset_progress_popup.enabled = !1
  }), this)
}, UpgradeScreen.prototype.onDeleteProgress = function() {
  SoundManager.instance.removeListeners(), AdsManager.instance = null, UpgradeScreen.instance = null, Cutter.instance = null, Trunk.instance = null, Fade.instance = null, SoundManager.instance = null, Barn.instance = null, Controls.instance = null, Arrow.instance.target = null, CarMovement.instance = null, CompleteMessage.instance = null, GameManager.instance.clearSaves(), this.skin_02_ad_watched && GameManager.instance.saveString("skin_02", "true"), this.skin_03_ad_watched && GameManager.instance.saveString("skin_03", "true"), this.skin_04_ad_watched && GameManager.instance.saveString("skin_04", "true"), GameManager.instance = null, this.app.root.destroy(), this.app.scenes.changeScene("Harvest")
}, UpgradeScreen.prototype.updateSkin = function(t) {
  this.current_skin = t, GameManager.instance.saveString("skin", t), CarMovement.instance.changeSkin(t), this.updateButtons()
}, UpgradeScreen.prototype.handleSkinClick = function(t) {
  AdsManager.instance.adActive || AdsManager.instance.showRewardedBreak(function(e) {
    e && (t(!0), SoundManager.instance.playSound("register"), this.updateButtons())
  }.bind(this))
}, UpgradeScreen.prototype.handleUpgrade = function(t, e) {
  GameManager.instance.money >= t ? (GameManager.instance.addMoney(-t), e(!1), SoundManager.instance.playSound("register"), this.updateButtons()) : AdsManager.instance.adActive || AdsManager.instance.showRewardedBreak(function(t) {
    t && (e(!0), SoundManager.instance.playSound("register"), this.updateButtons())
  }.bind(this))
}, UpgradeScreen.prototype.update = function(t) {
  this.cooldown -= t, !AdsManager.instance.adActive && this.app.keyboard.isPressed(pc.KEY_ESCAPE) && this.hide()
...
SoundManager.prototype.initialize = function() {
  SoundManager.instance = this, this.mute = !1, this.start_volume = this.entity.sound.volume, this.app.on("mute_down", this.toggleMute.bind(this))
}, SoundManager.prototype.toggleMute = function() {
  this.entity.sound && (this.mute = !this.mute, this.entity.sound.volume = this.mute ? 0 : this.start_volume)
