! function(t, e) {
  "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.ScratchStorage = e() : t.ScratchStorage = e()
}(self, () => (() => {
  var t = {
      945: (t, e, r) => {
        ...
        ! function(t) {
          ! function(e) {
            var o = void 0 !== t && t || "undefined" != typeof self && self || void 0 !== r.g && r.g || {},
            ...
            function g() {
              return this.bodyUsed = !1, this._initBody = function(t) {
                ...
                var t, e, r, o, n, s = y(this);
                if (s) return s;
                if (this._bodyBlob) return t = this._bodyBlob, r = b(e = new FileReader), n = (o = /charset=([A-Za-z0-9_-]+)/.exec(t.type)) ? o[1] : "utf-8", e.readAsText(t, n), r;
            ...
            function E(t, e) {
              ...
              if (t instanceof E) {
                ...
                this.url = t.url, this.credentials = t.credentials, e.headers || (this.headers = new p(t.headers)), this.method = t.method, this.mode = t.mode, this.signal = t.signal, s || null == t._bodyInit || (s = t._bodyInit, t.bodyUsed = !0)
              } else this.url = String(t);
              if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new p(e.headers)), this.method = (n = (r = e.method || this.method || "GET").toUpperCase(), v.indexOf(n) > -1 ? n : r), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal || function() {
              ...
              if (this._initBody(s), !("GET" !== this.method && "HEAD" !== this.method || "no-store" !== e.cache && "no-cache" !== e.cache)) {
                var i = /([?&])_=[^&]*/;
              ...
              return new Promise(function(n, s) {
                ...
                if (h.onload = function() {
                    var t, e, r = {
                      ...
                      headers: (t = h.getAllResponseHeaders() || "", e = new p, t.replace(/\r?\n[\t ]+/g, " ").split("\r").map(function(t) {
                    ...
                    0 === a.url.indexOf("file://") && (h.status < 200 || h.status > 599) ? r.status = 200 : r.status = h.status, r.url = "responseURL" in h ? h.responseURL : r.headers.get("X-Request-URL");
                  ...
                  }, h.open(a.method, function(t) {
                    try {
                      return "" === t && o.location.href ? o.location.href : t
                    } catch (e) {
                      return t
                    }
                  }(a.url), !0), "include" === a.credentials ? h.withCredentials = !0 : "omit" === a.credentials && (h.withCredentials = !1), "responseType" in h && (i ? h.responseType = "blob" : u && (h.responseType = "arraybuffer")), r && "object" == typeof r.headers && !(r.headers instanceof p || o.Headers && r.headers instanceof o.Headers)) {
                  var l = [];
                  Object.getOwnPropertyNames(r.headers).forEach(function(t) {
                    l.push(c(t)), h.setRequestHeader(t, d(r.headers[t]))
                  }), a.headers.forEach(function(t, e) {
                    -1 === l.indexOf(e) && h.setRequestHeader(e, t)
                  })
                } else a.headers.forEach(function(t, e) {
                  h.setRequestHeader(e, t)
                });
                a.signal && (a.signal.addEventListener("abort", f), h.onreadystatechange = function() {
                  4 === h.readyState && a.signal.removeEventListener("abort", f)
                }), h.send(void 0 === a._bodyInit ? null : a._bodyInit)
              })
            }
            _.polyfill = !0, o.fetch || (o.fetch = _, o.Headers = p, o.Request = E, o.Response = T), e.Headers = p, e.Request = E, e.Response = T, e.fetch = _
          }({})
  ...
  return postMessage({
    ...
    0 !== n || i || (i = setInterval(() => {
      s.length && (postMessage(s.slice(), s.map(t => t.buffer).filter(Boolean)), s.length = 0), 0 === n && (clearInterval(i), i = null)
    }, 1)), n++, o(e.url, e.options).then(t => t.ok ? t.arrayBuffer() : 404 === t.status ? null : Promise.reject(t.status)).then(t => s.push({
      id: e.id,
      buffer: t
    })).catch(t => s.push({
      id: e.id,
      error: t && t.message || "Failed request: ".concat(e.url)
    })).then(() => n--)
  }), {}
})());